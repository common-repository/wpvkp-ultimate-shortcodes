...
function wpvkp_shortcodes_button($atts, $content = null) {
	...
	return '<a href="'.$url.'" class="wpvkp-shortcode wpvkp-shortcode-button wpvkp-shortcode-button-colour-'.$colour.' wpvkp-shortcode-button-size-'.$size.' wpvkp-shortcode-button-edge-'.$edge.'" target="'.$target.'"'.$button_style.'>'.$icon.$label.'</a>';
...
function wpvkp_shortcodes_columns($atts, $content = null) {
	...
	$structure_class = ' wpvkp-shortcode-cols-'.$structure_class.' ';

	/* Return Columns */
	return '<div class="wpvkp-shortcode wpvkp-shortcode-cols '.$structure_class.'">'.do_shortcode($content).'</div>';
...
function wpvkp_shortcodes_column($atts, $content = null) {
	...
	return '<div class="wpvkp-shortcode wpvkp-shortcode-col wpvkp-shortcode-col-'.$position.'"><div class="wpvkp-shortcode-col-inner">'.wpautop(do_shortcode($content)).'</div></div>';

}
add_shortcode('wpvkp_col', 'wpvkp_shortcodes_column');



/* Social */

function wpvkp_social($atts, $content = null) {

	/* Return Social */
	return '<p class="wpvkp-shortcode wpvkp-shortcode-social-links">'.do_shortcode($content).'</p>';

}
add_shortcode('wpvkp_social', 'wpvkp_social');



/* Social Link */

function wpvkp_social_link($atts, $content = null) {
	...
	if(strpos($service, 'ja-social-icon-') !== false) {
		...
		$social_link_code = '<a href="'.$link.'" target="_blank" class="ja-social-icon-image"><img src="'.$ja_wpvkp_shortcodes_directory.'images/social-icons/'.$service.'.png" alt="'.$service.'" /></a>';
...
add_shortcode('wpvkp_social_link', 'wpvkp_social_link');



/* YouTube */

function wpvkp_shortcodes_media($atts, $content = null) {
	...
	/* YouTube */
		...
		$media_code = '<div class="wpvkp-shortcode wpvkp-shortcode-video-embed"><iframe width="'.$width.'" height="'.$height.'" src="//www.youtube.com/embed/'.$youtube_id.'" frameborder="0" allowfullscreen></iframe></div>';
	...
	/* Vimeo */
		...
		$media_code = '<div class="wpvkp-shortcode wpvkp-shortcode-video-embed"><iframe src="//player.vimeo.com/video/'.$vimeo_id.'" width="'.$width.'" height="'.$height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>';
...
add_shortcode('wpvkp_media', 'wpvkp_shortcodes_media');
...
function wpvkp_shortcodes_toggle($atts, $content = null) {
	...
	return '<div class="wpvkp-shortcode wpvkp-shortcode-toggle '.$active_class.'"><h3 class="wpvkp-shortcode wpvkp-shortcode-toggle-heading">'.$icon_code.$heading.$toggle_icons.'</h3><div class="wpvkp-shortcode wpvkp-shortcode-toggle-content"><p>'.do_shortcode($content).'</p></div></div>';
...
function wpvkp_shortcodes_accordion($atts, $content = null) {
	...
	/* Return Toggles */
	return '<div class="wpvkp-shortcode wpvkp-shortcode-accordion"><p>'.do_shortcode($content).'</p></div>';
...
function wpvkp_shortcodes_tabs($atts, $content = null) {
	/* Return Tabs */
	return '<div class="wpvkp-shortcode wpvkp-shortcode-tabs">'.do_shortcode($content).'</div>';
}
...
function wpvkp_shortcodes_tab($atts, $content = null) {
	...
	return '<div class="wpvkp-shortcode wpvkp-shortcode-tabpane"><div class="wpvkp-shortcode wpvkp-shortcode-tab-label">'.$label.'</div>'.wpautop(do_shortcode($content)).'</div>';
...
function wpvkp_shortcodes_map($atts, $content = null) {
	...
	if($infowindow_text) {
	    ...
	    $google_map_code .= '<div id="'.$content_map_id.'" class="wpvkp-shortcode-map" style="width:'.$width.';height:'.$height.';"></div>';
...
function wpvkp_add_google_map_code() {
	global $google_map_script_code;
...
add_action('wp_footer', 'wpvkp_add_google_map_code');



/* Alert Box */

function wpvkp_shortcodes_alertbox($atts, $content = null) {
	...
	return '<div class="wpvkp-shortcode wpvkp-shortcode-alertbox wpvkp-shortcode-alertbox-colour-'.$colour.'"'.$alertbox_style.'><p class="wpvkp-shortcode wpvkp-shortcode-alertbox-content">'.$icon_code.do_shortcode($content).'</p></div>';

}
add_shortcode('wpvkp_alertbox', 'wpvkp_shortcodes_alertbox');



/* Pull Quote Left */

function wpvkp_shortcodes_pullleft($atts, $content = null) {
	...
	return '<div class="wpvkp-shortcode wpvkp-shortcode-pullleft wpvkp-shortcode-pullleft-colour-'.$colour.'"'.$pullleft_style.'>'.$text.'</div>';

}
add_shortcode('wpvkp_pullleft', 'wpvkp_shortcodes_pullleft');



/* Pull Quote Right */

function wpvkp_shortcodes_pullright($atts, $content = null) {
	...
	return '<div class="wpvkp-shortcode wpvkp-shortcode-pullright wpvkp-shortcode-pullright-colour-'.$colour.'"'.$pullright_style.'>'.$text.'</div>';

}
add_shortcode('wpvkp_pullright', 'wpvkp_shortcodes_pullright');
